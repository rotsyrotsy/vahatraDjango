...
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity) VALUES (75, 'Haemaphysalis galidiae', 'Description of a new species of Haemaphysalis koch, 1844 (Acari: ixodidae) from the H. (Rhipistoma) asiatica subgroup, parasite of an endemic malagasy carnivoran (family eupleridae). Systematic Parasitology, 97: 591-599.', '2020-01-01', 'endemic tick known from endemic carnivora', 'A3');
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity) VALUES (76, 'Ixodes soarimalalae', 'Description of three new species of ixodes Latreille, 1795 (acari: ixodidae), parasites of tenrecs (Afrotheria: tenrecidae) on madagascar. Systematic Parasitology, 97: 623-637.', '2020-01-01', 'endemic tick known from malagasy shrew tenrecs and named after Voahangy soarimalala', 'A3');
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity) VALUES (77, 'Ixodes uilenbergi', 'Description of three new species of Ixodes latreille, 1795 (Acari: ixodidae), parasites of tenrecs (Afrotheria: tenrecidae) on madagascar. Systematic Parasitology, 97: 623-637.', '2020-01-01', 'endemic tick known from different species of malagasy tenrecs', 'A3');
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity) VALUES (78, 'Ixodes uncus', ' Description of three new species of ixodes Latreille, 1795 (Acari: ixodidae), parasites of tenrecs (Afrotheria: tenrecidae) on madagascar. Systematic Parasitology, 97: 623-637', '2020-01-01', 'endemic tick known from malagasy shrew tenrecs', 'A3');
...
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity) VALUES (99, 'Ours polaire', NULL, '2022-09-01', 'test kely fotsiny', 'A3');
...
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback) VALUES (25, 'Publications', '', NULL, 3, 'op1.gif', NULL);
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback) VALUES (26, 'Memoirs and thesis', '', NULL, 3, 'op2.gif', NULL);
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback) VALUES (27, 'Atlas of selected land vertebrates of Madagascar', 'While the past few decades have seen numerous publications about the extraordinary and highly endemic terrestrial vertebrate fauna of Madagascar, ranging from technical papers, to species descriptions, and field guides, no detailed mapping exercise has been completed in the form of an atlas. The purpose of this book is that, to bring together information from numerous sources and present distributional maps for a wide range of taxa, descriptive texts to interpret patterns, and, for most, habitat models (Maxent). For the different reptiles, birds, and mammals treated herein, this atlas is intended as a reference for students, researchers, naturalists, and conservationists.', '2013-01-01', 3, 'op3.gif', NULL);
