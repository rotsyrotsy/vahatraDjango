...
urlpatterns = [
    ...
    path("listActivities/<str:activity_id>/sub-activity-<str:subactivity_id>/<str:yearstr>-<int:year>/page-<int:page>", views.listActivities, name="listActivities"),
    path("listActivities/<str:activity_id>/<str:yearstr>-<int:year>/page-<int:page>", views.listActivities, name="listActivities"),
