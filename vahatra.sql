...
CREATE TABLE public.typememberimage (
    id bigint NOT NULL,
    image character varying(255),
    idtypemember bigint NOT NULL
);
...
ALTER TABLE public.typememberimage OWNER TO postgres;

--
-- Name: typememberimage_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.typememberimage_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.typememberimage_id_seq OWNER TO postgres;

--
-- Name: typememberimage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.typememberimage_id_seq OWNED BY public.typememberimage.id;
...
ALTER TABLE ONLY public.typememberimage ALTER COLUMN id SET DEFAULT nextval('public.typememberimage_id_seq'::regclass);
...
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (87, 'E-book sur les aires protégées de madagascar et autres outils pour les utilisateurs', 'Fin 2015, l''Association Vahatra a reçu une subvention de trois ans de la part du CEPF pour
réaliser une revue à grande échelle du système des aires protégées de Madagascar.
L''ouvrage bilingue français-anglais en trois volumes intitulé Les aires protégées
terrestres de Madagascar : leur histoire, description et biote / Terrestrial
protected areas of Madagascar : Leur histoire, description et biote a été
publié par l''Association Vahatra fin 2018.

Sur la base d''une subvention supplémentaire
du CEPF à Strand Life Science (Bangalore, Inde), avec l''association
Vahatra en tant que partenaire, un livre électronique d''une version revue et corrigée du
livre sur les aires protégées a été produit et est distribué par The University
de Chicago (https://w.bibliovault.org/BV.titles.epl?pc=596&sort=title).
Les volumes imprimés du livre sur les aires protégées sont pour le moins encombrants, pesant près de 7 kg, et la version e-book facilite grandement leur
utilisation. De plus, afin de simplifier l''utilisation et d''être plus convivial, des
e-books distincts ont été préparés pour les versions française et anglaise.
D''autres aspects de ce projet comprennent la création d''un site web en malgache, français et anglais, contenant de nombreux détails sur les 98 aires protégées terrestres de Madagascar couvertes par le livre, y compris des listes d''espèces de vertébrés connus de chaque site, ainsi que les moyens pour les scientifiques et naturalistes citoyens de mettre à jour les listes d''espèces téléchargeables en fonction de nouvelles observations et de données publiées.

Basé sur la présentation d''un séminaire d''une journée à Antananarivo par Thomas Vattakaven et Prabhakar Rajagopal de Strand Life Science et différents membres de l''Association Vitalia.
Life Science et différents membres de l''Association Vahatra aux utilisateurs potentiels du site, d''importantes contributions ont été reçues sur les aspects facilitant l''organisation du site. Le séminaire a eu lieu juste avant le début de l''épidémie de COVID-19 et tout le travail ultérieur sur le projet s''est fait
par courrier électronique et par vidéoconférence.

Un autre aspect important de ce projet a été le téléchargement sur cloud et la fourniture d''un accès gratuit à environ 9000 fichiers pdf utilisés pour la rédaction du livre, qui comprennent une gamme de différents types de publications, des rapports inédits, des mémoires de DEA et de maîtrise, des thèses de doctorat, etc.

Le site portail des Aires Protégées de Madagascar est
accessible à l''adresse https://protectedareas.mg/. Ce portail est un outil important pour
chercheurs, étudiants et défenseurs de l''environnement à Madagascar et à l''étranger, nous espérons faire évoluer le projet vers des étapes plus avancées. Au début du mois de décembre
2021, nos collègues de Strand Life Sciences à Bangalore ont présenté officiellement le portail à Madagascar par vidéoconférence, qui a été suivie d''une réception. L''événement a été couvert par la presse
et de la télévision. Le rapport final accepté par le CEPF a été soumis fin 2021 et la première phase du projet est maintenant terminée.', '2015-01-01', NULL, 'A4', 'projet/subvention/e-book-sur-les-aires-protegees-de-madagascar-et-autres-outils-pour-les-utilisateurs-87', 'SA6', 'In late 2015, Association Vahatra received a three-year grant from CEPF to
...
late 2021 and the first phase of the project has now been completed.', 'Fin 2015, l''Association Vahatra a reçu une subvention de trois ans de la part du CEPF pour
réaliser une revue à grande échelle du système des aires protégées de Madagascar.
L''ouvrage bilingue français-anglais en trois volumes intitulé Les aires protégées
terrestres de Madagascar : leur histoire, description et biote / Terrestrial
protected areas of Madagascar : Leur histoire, description et biote a été
...
chercheurs, étudiants et défenseurs de l''environnement à Madagascar et à l''étranger, nous espérons faire évoluer le projet vers des étapes plus avancées. Au début du mois de décembre
2021, nos collègues de Strand Life Sciences à Bangalore ont présenté officiellement le portail à Madagascar par vidéoconférence, qui a été suivie d''une réception. L''événement a été couvert par la presse
et de la télévision. Le rapport final accepté par le CEPF a été soumis fin 2021 et la première phase du projet est maintenant terminée.', NULL, NULL, 'E-book on the protected areas of madagascar and other user tools', 'E-book sur les aires protégées de madagascar et autres outils pour les utilisateurs');
...
INSERT INTO public.activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (150, 'Person In Focus: Marie Jeanne Raherilalao', 'After finishing her PhD at The University of Antananarivo in 2006 and in the
...
our congratulations for presenting her HDR.', '2021-10-01', NULL, 'A2', 'conference/vahatras-event/person-in-focus-marie-jeanne-raherilalao-150', 'SA4', 'After finishing her PhD at The University of Antananarivo in 2006 and in the
...
INSERT INTO public.auth_permission (id, name, content_type_id, codename) VALUES (137, 'Can add typememberimage', 40, 'add_typememberimage');
INSERT INTO public.auth_permission (id, name, content_type_id, codename) VALUES (138, 'Can change typememberimage', 40, 'change_typememberimage');
INSERT INTO public.auth_permission (id, name, content_type_id, codename) VALUES (139, 'Can delete typememberimage', 40, 'delete_typememberimage');
INSERT INTO public.auth_permission (id, name, content_type_id, codename) VALUES (140, 'Can view typememberimage', 40, 'view_typememberimage');
...
INSERT INTO public.auth_user (id, password, last_login, is_superuser, username, first_name, last_name, email, is_staff, is_active, date_joined) VALUES (1, 'pbkdf2_sha256$320000$nkcaCOpE7ULdtuPnMpwu0x$E1EoIGghemdmcj6UPpQ5uWaSwCOUY79vWHkcakwpbJU=', '2022-11-07 09:29:06.342947-01', true, 'Vahatra', '', '', 'rotsyvonimanitra@hotmail.com', true, true, '2022-09-29 10:57:53.533944-01');
...
INSERT INTO public.django_content_type (id, app_label, model) VALUES (40, 'association', 'typememberimage');
...
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (85, 'activities', '0023_alter_activity_date_alter_activity_idtypeactivity_and_more', '2022-11-02 04:52:17.456107-01');
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (86, 'association', '0016_typememberimage', '2022-11-02 04:52:17.932436-01');
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (87, 'association', '0017_auto_20221102_0912', '2022-11-02 05:12:44.268718-01');
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (88, 'activities', '0024_alter_activity_date', '2022-11-03 05:01:02.088589-01');
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (89, 'activities', '0025_alter_activity_date', '2022-11-03 05:01:02.188749-01');
INSERT INTO public.django_migrations (id, app, name, applied) VALUES (90, 'association', '0018_remove_typemember_image', '2022-11-03 05:01:02.304254-01');
...
INSERT INTO public.person (id, name, username, title) VALUES (395, 'test', 'Testing', NULL);
INSERT INTO public.person (id, name, username, title) VALUES (397, 'Wohlhauser', 'Sébastien', NULL);
...
INSERT INTO public.person (id, name, username, title) VALUES (396, 'test', 'Tahina', NULL);
INSERT INTO public.person (id, name, username, title) VALUES (398, 'Dijkstra', 'Klaas-Douwe B.', NULL);
INSERT INTO public.person (id, name, username, title) VALUES (402, 'Jungers', 'William L.', NULL);
...
INSERT INTO public.person (id, name, username, title) VALUES (393, 'scdsd', 'cdsc', NULL);
INSERT INTO public.person (id, name, username, title) VALUES (399, 'Cohen', 'Callan', NULL);
...
INSERT INTO public.person (id, name, username, title) VALUES (400, 'Peeters', 'Christian', NULL);
...
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback, description_en, description_fr) VALUES (28, 'The terrestrial protected areas of Madagascar: their history, description and biota.', NULL, '2021-04-15', 3, '978-2-9570997-1-9-frontcover.webp', 'op4_back.webp', NULL, NULL);
...
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback, description_en, description_fr) VALUES (27, 'Atlas d''une selection de vertébrés terrestres de Madagascar', 'While the past few decades have seen numerous publications about the extraordinary and highly endemic terrestrial vertebrate fauna of Madagascar, ranging from technical papers, to species descriptions, and field guides, no detailed mapping exercise has been completed in the form of an atlas. The purpose of this book is that, to bring together information from numerous sources and present distributional maps for a wide range of taxa, descriptive texts to interpret patterns, and, for most, habitat models (Maxent). For the different reptiles, birds, and mammals treated herein, this atlas is intended as a reference for students, researchers, naturalists, and conservationists.', '2013-01-01', 3, 'op3.webp', 'op3_back.webp', 'While the past few decades have seen numerous publications about the extraordinary and highly endemic terrestrial vertebrate fauna of Madagascar, ranging from technical papers, to species descriptions, and field guides, no detailed mapping exercise has been completed in the form of an atlas. The purpose of this book is that, to bring together information from numerous sources and present distributional maps for a wide range of taxa, descriptive texts to interpret patterns, and, for most, habitat models (Maxent). For the different reptiles, birds, and mammals treated herein, this atlas is intended as a reference for students, researchers, naturalists, and conservationists.', 'Alors que les dernières décennies ont vu de nombreuses publications sur l''extraordinaire et hautement endémique faune vertébrée terrestre de Madagascar, allant des articles techniques, aux descriptions d''espèces, et aux guides de terrain, 
...
INSERT INTO public.publication (id, title, description, date, idtype, imagefront, imageback, description_en, description_fr) VALUES (55, 'The protected areas of Lokombe, Ankarana, and Montagne d''Ambre in northern Madagascar', 'The three editors of this book were also the co-editors of a three-volume book (2018), The terrestrial protected areas of Madagascar: Their history, description, and biota.', '2022-11-14', 2, NULL, NULL, 'The three editors of this book were also the co-editors of a three-volume book (2018), The terrestrial protected areas of Madagascar: Their history, description, and biota.', 'Les trois éditeurs de ce livre étaient également les coéditeurs d''un livre en trois volumes (2018). Les aires protégées terrestres de Madagascar: Leur histoire, description et biote.');
...
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (455, 4, 55);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (459, 2, 55);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (460, 397, 55);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (461, 399, 24);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (462, 398, 24);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (463, 400, 23);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (464, 351, 23);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (465, 91, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (466, 90, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (467, 229, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (468, 84, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (469, 80, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (470, 1, 22);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (471, 91, 21);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (472, 229, 21);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (473, 1, 21);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (474, 402, 20);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (475, 4, 20);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (476, 4, 19);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (477, 3, 17);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (478, 4, 17);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (479, 2, 18);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (480, 4, 18);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (481, 4, 16);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (482, 4, 28);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (483, 2, 28);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (484, 397, 28);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (485, 4, 27);
INSERT INTO public.publicationauthor (id, idperson, idpublication) VALUES (486, 2, 27);
...
INSERT INTO public.sequences_sequence (name, last) VALUES ('typeactivity', 26);
...
INSERT INTO public.typemember (id, type, description, description_en, description_fr, type_en, type_fr) VALUES (2, 'scientists', 'They are the founding members of the association.', 'They are the founding members of the association.', 'Ce sont les membres fondateurs de l''association.', 'scientists', 'scientifiques');
INSERT INTO public.typemember (id, type, description, description_en, description_fr, type_en, type_fr) VALUES (4, 'staff', 'The current staff includes seven individuals', 'The current staff includes seven individuals', 'Le personnel actuel comprend sept personnes', 'staff', 'personnels');
...
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (2, 'BEA_113.webp', 1);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (3, 'cc1.webp', 1);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (4, 'Amena_035.webp', 2);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (5, 'Beman_037.webp', 3);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (6, 'Grop_090.webp', 3);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (7, 'DSC_0126.webp', 3);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (8, 'Etudiants.webp', 3);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (9, 'Groupe.webp', 4);
INSERT INTO public.typememberimage (id, image, idtypemember) VALUES (10, 'DSC_0587.webp', 4);
...
SELECT pg_catalog.setval('public.activityimage_id_seq', 357, true);
...
SELECT pg_catalog.setval('public.imagetype_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.member_id_seq', 74, true);
...
SELECT pg_catalog.setval('public.person_id_seq', 402, true);
...
SELECT pg_catalog.setval('public.publication_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.publicationauthor_id_seq', 486, true);
...
SELECT pg_catalog.setval('public.publicationdetail_id_seq', 249, true);
...
SELECT pg_catalog.setval('public.typemember_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.typememberimage_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.typepublication_id_seq', 9, true);
...
ALTER TABLE ONLY public.typememberimage
...
CREATE INDEX typememberimage_idtypemember_525b33c3 ON public.typememberimage USING btree (idtypemember);
...
ALTER TABLE ONLY public.typememberimage
    ADD CONSTRAINT typememberimage_idtypemember_525b33c3_fk_typemember_id FOREIGN KEY (idtypemember) REFERENCES public.typemember(id) DEFERRABLE INITIALLY DEFERRED;
