...
ALTER TABLE activityimage OWNER TO postgres;

--
-- Name: activityimage_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE activityimage_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE activityimage_id_seq OWNER TO postgres;

--
-- Name: activityimage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE activityimage_id_seq OWNED BY activityimage.id;
...
ALTER TABLE activityinstitution OWNER TO postgres;

--
-- Name: activityinstitution_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE activityinstitution_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE activityinstitution_id_seq OWNER TO postgres;

--
-- Name: activityinstitution_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE activityinstitution_id_seq OWNED BY activityinstitution.id;
...
ALTER TABLE activityperson OWNER TO postgres;
...
ALTER TABLE activityperson_id_seq OWNER TO postgres;

--
-- Name: activityperson_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE activityperson_id_seq OWNED BY activityperson.id;
...
ALTER TABLE fieldschool OWNER TO postgres;

--
-- Name: fieldschool_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE fieldschool_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE fieldschool_id_seq OWNER TO postgres;

--
-- Name: fieldschool_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE fieldschool_id_seq OWNED BY fieldschool.id;
...
CREATE VIEW intervenantfieldschool AS
 SELECT v.id,
        CASE
        ...
        END AS intervenant
   FROM (((visit v
     JOIN fieldschool f ON ((f.idvisit = v.id)))
     LEFT JOIN institution i ON (((i.id)::text = (f.idinst)::text)))
     LEFT JOIN department d ON (((d.id)::text = (f.iddept)::text)));


ALTER TABLE intervenantfieldschool OWNER TO postgres;
...
ALTER TABLE memberpostinst OWNER TO postgres;

--
-- Name: memberpostinst_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE memberpostinst_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE memberpostinst_id_seq OWNER TO postgres;

--
-- Name: memberpostinst_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE memberpostinst_id_seq OWNED BY memberpostinst.id;
...
ALTER TABLE messageofyear OWNER TO postgres;

--
-- Name: messageofyear_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE messageofyear_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE messageofyear_id_seq OWNER TO postgres;

--
-- Name: messageofyear_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE messageofyear_id_seq OWNED BY messageofyear.id;
...
ALTER TABLE publicationauthor OWNER TO postgres;

--
-- Name: publicationauthor_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE publicationauthor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE publicationauthor_id_seq OWNER TO postgres;

--
-- Name: publicationauthor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE publicationauthor_id_seq OWNED BY publicationauthor.id;
...
ALTER TABLE publicationdetail OWNER TO postgres;

--
-- Name: publicationdetail_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE publicationdetail_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE publicationdetail_id_seq OWNER TO postgres;

--
-- Name: publicationdetail_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE publicationdetail_id_seq OWNED BY publicationdetail.id;
...
ALTER TABLE sequences_sequence OWNER TO postgres;
...
ALTER TABLE typeactivity OWNER TO postgres;
...
ALTER TABLE typemember OWNER TO postgres;

--
-- Name: typemember_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE typemember_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE typemember_id_seq OWNER TO postgres;

--
-- Name: typemember_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE typemember_id_seq OWNED BY typemember.id;


--
-- Name: typememberimage; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE typememberimage (
    id bigint NOT NULL,
    image character varying(255),
    idtypemember bigint NOT NULL
);
...
ALTER TABLE typememberimage OWNER TO postgres;

--
-- Name: typememberimage_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE typememberimage_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE typememberimage_id_seq OWNER TO postgres;

--
-- Name: typememberimage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE typememberimage_id_seq OWNED BY typememberimage.id;
...
ALTER TABLE typepublication OWNER TO postgres;

--
-- Name: typepublication_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE typepublication_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE typepublication_id_seq OWNER TO postgres;

--
-- Name: typepublication_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE typepublication_id_seq OWNED BY typepublication.id;
...
ALTER TABLE typesubactivity OWNER TO postgres;
...
ALTER TABLE ONLY activityimage ALTER COLUMN id SET DEFAULT nextval('activityimage_id_seq'::regclass);
...
ALTER TABLE ONLY activityinstitution ALTER COLUMN id SET DEFAULT nextval('activityinstitution_id_seq'::regclass);
...
ALTER TABLE ONLY activityperson ALTER COLUMN id SET DEFAULT nextval('activityperson_id_seq'::regclass);
...
ALTER TABLE ONLY fieldschool ALTER COLUMN id SET DEFAULT nextval('fieldschool_id_seq'::regclass);
...
ALTER TABLE ONLY memberpostinst ALTER COLUMN id SET DEFAULT nextval('memberpostinst_id_seq'::regclass);
...
ALTER TABLE ONLY messageofyear ALTER COLUMN id SET DEFAULT nextval('messageofyear_id_seq'::regclass);
...
ALTER TABLE ONLY publicationauthor ALTER COLUMN id SET DEFAULT nextval('publicationauthor_id_seq'::regclass);
...
ALTER TABLE ONLY publicationdetail ALTER COLUMN id SET DEFAULT nextval('publicationdetail_id_seq'::regclass);
...
ALTER TABLE ONLY typemember ALTER COLUMN id SET DEFAULT nextval('typemember_id_seq'::regclass);


--
-- Name: typememberimage id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY typememberimage ALTER COLUMN id SET DEFAULT nextval('typememberimage_id_seq'::regclass);
...
ALTER TABLE ONLY typepublication ALTER COLUMN id SET DEFAULT nextval('typepublication_id_seq'::regclass);
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (27, 'Field Schools', NULL, '2015-01-01', NULL, 'A1', 'visit/field-school/field-schools-27', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (29, 'Field Schools', NULL, '2014-01-01', NULL, 'A1', 'visit/field-school/field-schools-29', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (36, 'Field Schools', NULL, '2009-01-01', NULL, 'A1', 'visit/field-school/field-schools-36', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (40, 'Field Schools', NULL, '2004-01-01', NULL, 'A1', 'visit/field-school/field-schools-40', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (41, 'Field Schools', NULL, '2003-01-01', NULL, 'A1', 'visit/field-school/field-schools-41', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (42, 'Field Schools', NULL, '2002-01-01', NULL, 'A1', 'visit/field-school/field-schools-42', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (31, 'Field Schools', NULL, '2013-01-01', NULL, 'A1', 'visit/field-school/field-schools-31', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (45, 'Field Schools', NULL, '2001-01-01', NULL, 'A1', 'visit/field-school/field-schools-45', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (139, 'L''histoire, le statut actuel et l''avenir des aires protégées à Madagascar', '<p>L''histoire, le statut actuel et l''avenir des aires protégées à Madagascar. protégées à Madagascar.<br>Plénière invitée. 56e réunion annuelle de l''Association for Tropical Biology and Conservation, 30 juillet au 3 août 2019, Antananarivo, Madagascar</p>', '2019-07-08', NULL, 'A2', 'conference/vahatras-cooperation/the-history-current-status-and-future-of-the-protected-areas-in-madagascar-139', 'SA5', '<p>The history, current status, and future of the protected areas in Madagascar.<br>Invited plenary. 56th annual meeting of the Association for Tropical Biology and Conservation, 30 July to 3 august 2019, Antananarivo, Madagascar</p>', '<p>L''histoire, le statut actuel et l''avenir des aires protégées à Madagascar. protégées à Madagascar.<br>Plénière invitée. 56e réunion annuelle de l''Association for Tropical Biology and Conservation, 30 juillet au 3 août 2019, Antananarivo, Madagascar</p>', NULL, NULL, 'The history, current status, and future of the protected areas in Madagascar', 'L''histoire, le statut actuel et l''avenir des aires protégées à Madagascar');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (33, 'Field Schools', NULL, '2011-01-01', NULL, 'A1', 'visit/field-school/field-schools-33', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (43, 'Field Schools', NULL, '2001-01-01', NULL, 'A1', 'visit/field-school/field-schools-43', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activity (id, title, description, date, note, idtypeactivity, slug, idtypesubactivity, description_en, description_fr, note_en, note_fr, title_en, title_fr) VALUES (34, 'Field Schools', NULL, '2010-01-01', NULL, 'A1', 'visit/field-school/field-schools-34', 'SA2', NULL, NULL, NULL, NULL, 'Field Schools', 'Ecole de terrain');
...
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (1, 29, 'I37');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (2, 31, 'I37');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (3, 87, 'I14');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (4, 88, 'I14');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (5, 88, 'I20');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (6, 89, 'I21');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (7, 89, 'I22');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (8, 89, 'I23');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (9, 90, 'I24');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (10, 90, 'I25');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (11, 90, 'I7');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (12, 91, 'I26');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (13, 91, 'I27');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (14, 91, 'I28');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (15, 93, 'I29');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (16, 93, 'I30');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (35, 146, 'I1');
INSERT INTO activityinstitution (id, idactivity, idinst) VALUES (36, 65, 'I33');
...
INSERT INTO administrator (id, username, mail, password) VALUES ('ADM1', 'Vahatra', 'rotsyvonimanitra@hotmail.com', 'pbkdf2_sha256$320000$mJXSsBH7OkNLznzIECUbDG$paGjnBWxKZg7f+9gdbIDAdMtGelgnaGA+/yzI/VOGGE=');
...
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (9, 'Can add user', 4, 'add_user');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (10, 'Can change user', 4, 'change_user');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (11, 'Can delete user', 4, 'delete_user');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (12, 'Can view user', 4, 'view_user');
...
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (16, 'Can view content type', 5, 'view_contenttype');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (17, 'Can add session', 6, 'add_session');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (18, 'Can change session', 6, 'change_session');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (19, 'Can delete session', 6, 'delete_session');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (20, 'Can view session', 6, 'view_session');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (21, 'Can add department', 9, 'add_department');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (22, 'Can change department', 9, 'change_department');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (23, 'Can delete department', 9, 'delete_department');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (24, 'Can view department', 9, 'view_department');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (25, 'Can add imagetype', 10, 'add_imagetype');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (26, 'Can change imagetype', 10, 'change_imagetype');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (27, 'Can delete imagetype', 10, 'delete_imagetype');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (28, 'Can view imagetype', 10, 'view_imagetype');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (29, 'Can add institution', 11, 'add_institution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (30, 'Can change institution', 11, 'change_institution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (31, 'Can delete institution', 11, 'delete_institution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (32, 'Can view institution', 11, 'view_institution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (33, 'Can add member', 12, 'add_member');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (34, 'Can change member', 12, 'change_member');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (35, 'Can delete member', 12, 'delete_member');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (36, 'Can view member', 12, 'view_member');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (37, 'Can add person', 13, 'add_person');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (38, 'Can change person', 13, 'change_person');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (39, 'Can delete person', 13, 'delete_person');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (40, 'Can view person', 13, 'view_person');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (41, 'Can add post', 14, 'add_post');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (42, 'Can change post', 14, 'change_post');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (43, 'Can delete post', 14, 'delete_post');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (44, 'Can view post', 14, 'view_post');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (45, 'Can add typemember', 15, 'add_typemember');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (46, 'Can change typemember', 15, 'change_typemember');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (47, 'Can delete typemember', 15, 'delete_typemember');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (48, 'Can view typemember', 15, 'view_typemember');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (49, 'Can add partner', 17, 'add_partner');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (50, 'Can change partner', 17, 'change_partner');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (51, 'Can delete partner', 17, 'delete_partner');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (52, 'Can view partner', 17, 'view_partner');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (53, 'Can add messageofyear', 18, 'add_messageofyear');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (54, 'Can change messageofyear', 18, 'change_messageofyear');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (55, 'Can delete messageofyear', 18, 'delete_messageofyear');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (56, 'Can view messageofyear', 18, 'view_messageofyear');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (57, 'Can add memberpostinst', 19, 'add_memberpostinst');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (58, 'Can change memberpostinst', 19, 'change_memberpostinst');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (59, 'Can delete memberpostinst', 19, 'delete_memberpostinst');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (60, 'Can view memberpostinst', 19, 'view_memberpostinst');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (61, 'Can add image', 20, 'add_image');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (62, 'Can change image', 20, 'change_image');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (63, 'Can delete image', 20, 'delete_image');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (64, 'Can view image', 20, 'view_image');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (65, 'Can add intervenantfieldschool', 21, 'add_intervenantfieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (66, 'Can change intervenantfieldschool', 21, 'change_intervenantfieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (67, 'Can delete intervenantfieldschool', 21, 'delete_intervenantfieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (68, 'Can view intervenantfieldschool', 21, 'view_intervenantfieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (69, 'Can add activity', 22, 'add_activity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (70, 'Can change activity', 22, 'change_activity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (71, 'Can delete activity', 22, 'delete_activity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (72, 'Can view activity', 22, 'view_activity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (73, 'Can add location', 23, 'add_location');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (74, 'Can change location', 23, 'change_location');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (75, 'Can delete location', 23, 'delete_location');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (76, 'Can view location', 23, 'view_location');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (77, 'Can add typeactivity', 24, 'add_typeactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (78, 'Can change typeactivity', 24, 'change_typeactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (79, 'Can delete typeactivity', 24, 'delete_typeactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (80, 'Can view typeactivity', 24, 'view_typeactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (81, 'Can add typesubactivity', 25, 'add_typesubactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (82, 'Can change typesubactivity', 25, 'change_typesubactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (83, 'Can delete typesubactivity', 25, 'delete_typesubactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (84, 'Can view typesubactivity', 25, 'view_typesubactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (85, 'Can add visit', 26, 'add_visit');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (86, 'Can change visit', 26, 'change_visit');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (87, 'Can delete visit', 26, 'delete_visit');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (88, 'Can view visit', 26, 'view_visit');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (89, 'Can add fieldschool', 27, 'add_fieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (90, 'Can change fieldschool', 27, 'change_fieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (91, 'Can delete fieldschool', 27, 'delete_fieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (92, 'Can view fieldschool', 27, 'view_fieldschool');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (93, 'Can add activityperson', 28, 'add_activityperson');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (94, 'Can change activityperson', 28, 'change_activityperson');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (95, 'Can delete activityperson', 28, 'delete_activityperson');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (96, 'Can view activityperson', 28, 'view_activityperson');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (97, 'Can add activityinstitution', 29, 'add_activityinstitution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (98, 'Can change activityinstitution', 29, 'change_activityinstitution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (99, 'Can delete activityinstitution', 29, 'delete_activityinstitution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (100, 'Can view activityinstitution', 29, 'view_activityinstitution');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (101, 'Can add activityimage', 30, 'add_activityimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (102, 'Can change activityimage', 30, 'change_activityimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (103, 'Can delete activityimage', 30, 'delete_activityimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (104, 'Can view activityimage', 30, 'view_activityimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (105, 'Can add publication', 31, 'add_publication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (106, 'Can change publication', 31, 'change_publication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (107, 'Can delete publication', 31, 'delete_publication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (108, 'Can view publication', 31, 'view_publication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (109, 'Can add typepublication', 32, 'add_typepublication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (110, 'Can change typepublication', 32, 'change_typepublication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (111, 'Can delete typepublication', 32, 'delete_typepublication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (112, 'Can view typepublication', 32, 'view_typepublication');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (113, 'Can add publicationdetail', 33, 'add_publicationdetail');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (114, 'Can change publicationdetail', 33, 'change_publicationdetail');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (115, 'Can delete publicationdetail', 33, 'delete_publicationdetail');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (116, 'Can view publicationdetail', 33, 'view_publicationdetail');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (117, 'Can add publicationauthor', 34, 'add_publicationauthor');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (118, 'Can change publicationauthor', 34, 'change_publicationauthor');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (119, 'Can delete publicationauthor', 34, 'delete_publicationauthor');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (120, 'Can view publicationauthor', 34, 'view_publicationauthor');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (121, 'Can add administrator', 35, 'add_administrator');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (122, 'Can change administrator', 35, 'change_administrator');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (123, 'Can delete administrator', 35, 'delete_administrator');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (124, 'Can view administrator', 35, 'view_administrator');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (125, 'Can add sequence', 36, 'add_sequence');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (126, 'Can change sequence', 36, 'change_sequence');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (127, 'Can delete sequence', 36, 'delete_sequence');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (128, 'Can view sequence', 36, 'view_sequence');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (129, 'Can add web p image', 38, 'add_webpimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (130, 'Can change web p image', 38, 'change_webpimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (131, 'Can delete web p image', 38, 'delete_webpimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (132, 'Can view web p image', 38, 'view_webpimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (133, 'Can add sub activity', 39, 'add_subactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (134, 'Can change sub activity', 39, 'change_subactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (135, 'Can delete sub activity', 39, 'delete_subactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (136, 'Can view sub activity', 39, 'view_subactivity');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (137, 'Can add typememberimage', 40, 'add_typememberimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (138, 'Can change typememberimage', 40, 'change_typememberimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (139, 'Can delete typememberimage', 40, 'delete_typememberimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (140, 'Can view typememberimage', 40, 'view_typememberimage');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (141, 'Can add report', 41, 'add_report');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (142, 'Can change report', 41, 'change_report');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (143, 'Can delete report', 41, 'delete_report');
INSERT INTO auth_permission (id, name, content_type_id, codename) VALUES (144, 'Can view report', 41, 'view_report');
...
INSERT INTO department (id, name) VALUES ('D1', 'Department of Animal Biology');
INSERT INTO department (id, name) VALUES ('D2', 'Department of Water and Forests');
INSERT INTO department (id, name) VALUES ('D3', 'Tierökologie und Naturschutz');
INSERT INTO department (id, name) VALUES ('D4', 'Biological Science Department');
INSERT INTO department (id, name) VALUES ('D5', 'Institut des Sciences et Techniques de l’Environnement (ISTE)');
INSERT INTO department (id, name) VALUES ('D6', 'School of Agronomy, Forest Department');
...
INSERT INTO django_content_type (id, app_label, model) VALUES (7, 'association', 'memberviewposts');
INSERT INTO django_content_type (id, app_label, model) VALUES (8, 'association', 'degree');
INSERT INTO django_content_type (id, app_label, model) VALUES (9, 'association', 'department');
INSERT INTO django_content_type (id, app_label, model) VALUES (10, 'association', 'imagetype');
INSERT INTO django_content_type (id, app_label, model) VALUES (11, 'association', 'institution');
INSERT INTO django_content_type (id, app_label, model) VALUES (12, 'association', 'member');
INSERT INTO django_content_type (id, app_label, model) VALUES (13, 'association', 'person');
INSERT INTO django_content_type (id, app_label, model) VALUES (14, 'association', 'post');
INSERT INTO django_content_type (id, app_label, model) VALUES (15, 'association', 'typemember');
INSERT INTO django_content_type (id, app_label, model) VALUES (16, 'association', 'studentdegree');
INSERT INTO django_content_type (id, app_label, model) VALUES (17, 'association', 'partner');
INSERT INTO django_content_type (id, app_label, model) VALUES (18, 'association', 'messageofyear');
INSERT INTO django_content_type (id, app_label, model) VALUES (19, 'association', 'memberpostinst');
INSERT INTO django_content_type (id, app_label, model) VALUES (20, 'association', 'image');
INSERT INTO django_content_type (id, app_label, model) VALUES (21, 'activities', 'intervenantfieldschool');
INSERT INTO django_content_type (id, app_label, model) VALUES (22, 'activities', 'activity');
INSERT INTO django_content_type (id, app_label, model) VALUES (23, 'activities', 'location');
INSERT INTO django_content_type (id, app_label, model) VALUES (24, 'activities', 'typeactivity');
INSERT INTO django_content_type (id, app_label, model) VALUES (25, 'activities', 'typesubactivity');
INSERT INTO django_content_type (id, app_label, model) VALUES (26, 'activities', 'visit');
INSERT INTO django_content_type (id, app_label, model) VALUES (27, 'activities', 'fieldschool');
INSERT INTO django_content_type (id, app_label, model) VALUES (28, 'activities', 'activityperson');
INSERT INTO django_content_type (id, app_label, model) VALUES (29, 'activities', 'activityinstitution');
INSERT INTO django_content_type (id, app_label, model) VALUES (30, 'activities', 'activityimage');
INSERT INTO django_content_type (id, app_label, model) VALUES (31, 'publications', 'publication');
INSERT INTO django_content_type (id, app_label, model) VALUES (32, 'publications', 'typepublication');
INSERT INTO django_content_type (id, app_label, model) VALUES (33, 'publications', 'publicationdetail');
INSERT INTO django_content_type (id, app_label, model) VALUES (34, 'publications', 'publicationauthor');
INSERT INTO django_content_type (id, app_label, model) VALUES (35, 'admin', 'administrator');
INSERT INTO django_content_type (id, app_label, model) VALUES (36, 'sequences', 'sequence');
INSERT INTO django_content_type (id, app_label, model) VALUES (37, 'association', 'link');
INSERT INTO django_content_type (id, app_label, model) VALUES (38, 'webp_converter', 'webpimage');
INSERT INTO django_content_type (id, app_label, model) VALUES (39, 'activities', 'subactivity');
INSERT INTO django_content_type (id, app_label, model) VALUES (40, 'association', 'typememberimage');
INSERT INTO django_content_type (id, app_label, model) VALUES (41, 'association', 'report');
...
INSERT INTO django_migrations (id, app, name, applied) VALUES (1, 'association', '0001_initial', '2022-08-29 07:11:05.733637-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (2, 'activities', '0001_initial', '2022-08-29 07:11:07.790085-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (3, 'contenttypes', '0001_initial', '2022-08-29 07:11:08.071015-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (6, 'admin', '0002_logentry_remove_auto_add', '2022-08-29 07:11:10.762635-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (7, 'admin', '0003_logentry_add_action_flag_choices', '2022-08-29 07:11:10.777851-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (8, 'contenttypes', '0002_remove_content_type_name', '2022-08-29 07:11:10.812318-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (20, 'publications', '0001_initial', '2022-08-29 07:11:12.113767-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (21, 'sessions', '0001_initial', '2022-08-29 07:11:12.375259-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (22, 'activities', '0002_alter_activityimage_options', '2022-08-30 08:01:23.17467-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (23, 'association', '0002_degree_post_alter_imagetype_options_studentdegree_and_more', '2022-08-30 08:01:23.181111-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (24, 'publications', '0002_alter_publicationauthor_options_and_more', '2022-08-30 08:01:23.1861-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (25, 'admin', '0001_initial', '2022-08-31 07:57:04.766265-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (26, 'admin', '0002_alter_administrator_username', '2022-08-31 10:48:16.994362-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (27, 'sequences', '0001_initial', '2022-09-05 06:55:00.573623-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (28, 'sequences', '0002_alter_sequence_last', '2022-09-05 06:55:00.835734-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (29, 'activities', '0002_remove_activityimage_idimage_activityimage_image', '2022-09-05 10:11:40.730795-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (30, 'association', '0002_remove_member_idimage_member_image', '2022-09-05 10:11:40.753094-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (31, 'publications', '0002_remove_publication_idimageback_and_more', '2022-09-05 10:11:40.835872-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (32, 'activities', '0003_alter_activityimage_idactivity_and_more', '2022-09-22 13:01:50.531046-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (33, 'association', '0003_alter_image_idtype_alter_member_idperson_and_more', '2022-09-22 13:01:50.683102-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (34, 'publications', '0003_alter_publication_idtype_and_more', '2022-09-22 13:01:50.736179-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (35, 'association', '0004_delete_memberviewposts', '2022-09-22 13:02:21.593805-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (36, 'association', '0005_remove_studentdegree_iddegree_and_more', '2022-09-23 07:00:35.575703-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (37, 'association', '0006_link', '2022-09-23 10:30:08.523975-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (38, 'association', '0007_delete_link', '2022-09-23 10:34:10.626935-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (39, 'association', '0008_partner_islink', '2022-09-23 10:36:43.683195-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (40, 'association', '0009_typemember_image', '2022-09-27 12:15:56.936242-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (41, 'auth', '0001_initial', '2022-09-29 10:56:59.84501-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (42, 'auth', '0002_alter_permission_name_max_length', '2022-09-29 10:56:59.867947-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (43, 'auth', '0003_alter_user_email_max_length', '2022-09-29 10:56:59.877961-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (44, 'auth', '0004_alter_user_username_opts', '2022-09-29 10:56:59.889948-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (45, 'auth', '0005_alter_user_last_login_null', '2022-09-29 10:56:59.899958-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (46, 'auth', '0006_require_contenttypes_0002', '2022-09-29 10:56:59.903946-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (47, 'auth', '0007_alter_validators_add_error_messages', '2022-09-29 10:56:59.914882-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (48, 'auth', '0008_alter_user_username_max_length', '2022-09-29 10:57:00.001503-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (49, 'auth', '0009_alter_user_last_name_max_length', '2022-09-29 10:57:00.050651-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (50, 'auth', '0010_alter_group_name_max_length', '2022-09-29 10:57:00.071594-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (51, 'auth', '0011_update_proxy_permissions', '2022-09-29 10:57:00.098522-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (52, 'auth', '0012_alter_user_first_name_max_length', '2022-09-29 10:57:00.112485-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (53, 'association', '0010_alter_typemember_type', '2022-10-05 09:20:45.117279-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (54, 'activities', '0004_alter_typeactivity_type_alter_typesubactivity_type', '2022-10-11 09:55:02.257935-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (55, 'publications', '0004_alter_typepublication_type', '2022-10-11 09:55:02.4383-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (56, 'webp_converter', '0001_initial', '2022-10-11 09:55:02.695637-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (57, 'webp_converter', '0002_auto_20191202_1616', '2022-10-11 09:55:02.728547-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (58, 'webp_converter', '0003_auto_20191202_1621', '2022-10-11 09:55:02.735101-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (59, 'webp_converter', '0004_alter_webpimage_id', '2022-10-11 09:55:02.969952-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (60, 'activities', '0005_activity_slug', '2022-10-12 10:15:42.989877-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (61, 'activities', '0006_subactivity', '2022-10-17 06:50:09.003314-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (62, 'activities', '0007_visit_idsubactivity', '2022-10-17 06:59:52.258886-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (63, 'activities', '0008_remove_visit_idsubactivity_and_more', '2022-10-17 07:38:02.930362-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (64, 'activities', '0009_remove_visit_idtypesubactivity', '2022-10-18 06:20:41.566359-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (65, 'activities', '0010_alter_activity_date', '2022-10-19 11:15:36.844796-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (66, 'activities', '0011_alter_activity_date', '2022-10-26 08:06:24.69931-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (67, 'activities', '0012_alter_activity_date', '2022-10-26 08:06:24.707306-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (68, 'activities', '0013_alter_activity_date', '2022-10-26 08:10:33.202326-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (69, 'activities', '0014_alter_activity_date', '2022-10-26 11:22:03.404999-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (70, 'activities', '0015_alter_activity_date', '2022-10-26 11:22:03.413958-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (71, 'activities', '0016_alter_activity_date', '2022-10-26 11:22:03.423914-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (72, 'association', '0011_messageofyear_description_en_and_more', '2022-10-26 11:23:58.364248-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (73, 'association', '0012_member_description_en_member_description_fr', '2022-10-26 11:24:11.634024-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (74, 'association', '0013_imagetype_type_en_imagetype_type_fr_and_more', '2022-10-26 11:24:11.663593-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (75, 'activities', '0017_alter_activity_date', '2022-10-26 11:53:42.584033-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (76, 'association', '0014_typemember_type_en_typemember_type_fr', '2022-10-26 11:53:42.959912-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (77, 'activities', '0018_activity_description_en_activity_description_fr_and_more', '2022-10-27 06:08:11.525651-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (78, 'activities', '0019_alter_activity_date', '2022-10-27 10:26:36.39255-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (79, 'publications', '0005_publication_description_en_and_more', '2022-10-27 10:26:36.658992-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (80, 'activities', '0020_remove_activity_slug_en_remove_activity_slug_fr_and_more', '2022-10-27 12:04:55.091085-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (81, 'activities', '0021_auto_20221031_1434', '2022-10-31 10:37:43.858015-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (82, 'publications', '0006_auto_20221031_1437', '2022-10-31 10:40:49.327232-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (83, 'activities', '0022_auto_20221031_1446', '2022-10-31 10:54:49.106215-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (84, 'association', '0015_auto_20221031_1602', '2022-10-31 12:03:39.14071-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (85, 'activities', '0023_alter_activity_date_alter_activity_idtypeactivity_and_more', '2022-11-02 04:52:17.456107-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (86, 'association', '0016_typememberimage', '2022-11-02 04:52:17.932436-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (87, 'association', '0017_auto_20221102_0912', '2022-11-02 05:12:44.268718-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (88, 'activities', '0024_alter_activity_date', '2022-11-03 05:01:02.088589-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (89, 'activities', '0025_alter_activity_date', '2022-11-03 05:01:02.188749-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (90, 'association', '0018_remove_typemember_image', '2022-11-03 05:01:02.304254-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (91, 'activities', '0026_alter_activity_date', '2022-11-10 06:56:58.351501-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (92, 'association', '0019_report', '2022-11-10 06:56:59.074344-01');
INSERT INTO django_migrations (id, app, name, applied) VALUES (93, 'activities', '0027_alter_activity_date', '2022-11-10 06:59:44.16242-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('14kpcie5e2pwqq9oxhsb5m321uncy3r8', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oTNBd:I9pJ7LQvaFXMosZ8QwcDx08tRyMcBYx8bAnSnCkWXBA', '2022-09-14 11:51:17.3512-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('hfcu54w1cr47257eisrdgf73qff7gwp1', 'eyJhZG1pbiI6IkFETTEifQ:1oTNCY:pJeKVLAqM4EnqOpW4I3O617Wo7aRH4k8rjVRqrglPTQ', '2022-09-14 11:52:14.51081-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('vxlczur386dweikj3xnd52wc43fimv9d', 'eyJfc2Vzc2lvbl9leHBpcnkiOjB9:1oTeI6:gPHHRQ65MezyYxNG2PvXhk-Dd3eRWrpRcXzt5IuiCyA', '2022-09-15 06:07:06.435487-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('ut0aminiilzm855kxqvakbc4ft2k26t0', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oTibY:Pt1Gr9vZlB8rKpnLIA6OEBOd8cvkTEj4l6DHzkALoSY', '2022-09-15 10:43:28.654859-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('8dwwyzau63hurcsvm3bakofkwvsgnfe2', 'eyJfc2Vzc2lvbl9leHBpcnkiOjB9:1oVYOl:HEP9aok1qcCDJIZOW3Wp1MzXnWZMEzpYFzBZeAoJoMk', '2022-09-20 12:13:51.675972-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('8cmphysp161nfty057tt5o0b3utfjl8x', 'eyJfc2Vzc2lvbl9leHBpcnkiOjB9:1oWcC6:DoQrXHcKd0PAVbRcJSg0FoeqUAgBgc06cLSN-MVOTkw', '2022-09-23 10:29:10.122151-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('x248r8vnwq3qpd0dae7234nxevc2j7o4', 'eyJfc2Vzc2lvbl9leHBpcnkiOjB9:1oXj8R:L7VZSA-42_uJObLJdskBqdUI0zBWZd5jAGz7D62mmy4', '2022-09-26 12:05:59.865104-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('vb3k01lu20ac92xxdbk4um9yp7wq4md0', 'eyJfc2Vzc2lvbl9leHBpcnkiOjB9:1oXjpO:7qayWMD7B6pdGJto_dR_OMwnWahn816er7GHsJhftQs', '2022-09-26 12:50:22.756191-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('jejaz55c6r01fcx9r135jaxk7w0pm1s0', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oaWqT:Bh_KPEkvP0m9u07fUv5QRyD5RZIJlE7GAO83oWorEc8', '2022-10-04 05:35:01.787368-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('vqd1abeisgoyf75b1n6kbhq1slo3jlbb', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oaso1:qH3uGTybyILY8fORuZCN4nxrUD-jdSkpdqCj8Q8BdWM', '2022-10-05 05:01:57.011092-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('apychrj0k31l74ihmpcgnimvfy1gzlb1', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oaxEn:uE5g-htYnBWqAkeIxDLieRCnvfg6CYLyvVhCb1Q3E_I', '2022-10-05 09:45:53.62-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('1cq2lv5np93ukmarwn15tcvmy7dr5nu7', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1obFZN:hAAHPw0UYOSk7L4kyx-cQ3rZ-2sQwNoc-HPZUUK8GDw', '2022-10-06 05:20:21.045685-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('eh3iocnscbkncblo3lqs0g619uehf5xq', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1obbwr:gkGDDTitD3BQOtCy2-jpvpFdaRDDlD2Qm7IPhuqPxd8', '2022-10-07 05:14:05.286858-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('0ycb9z9h05iwu1mwn8ocoufulsoqxxoz', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1oco1p:ke7TlqZj54Klukam5td_jnSoPCwdoMVOGz2YGxQCfZY', '2022-10-10 12:20:09.016281-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('161tovt27y2h62vghu2oed5qinacywwx', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1od4uV:jDmxZgbakDqkD-lHdljxpPEvAh21zD5L6i0kOriOZjE', '2022-10-11 06:21:43.851735-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('4v72axzmezrsfib02vk6nl7s3k9brs9b', 'eyJfc2Vzc2lvbl9leHBpcnkiOjAsImFkbWluIjoiQURNMSJ9:1odQb7:aJggkQBwaDR-Yc-gY5D0OXPlGoRPTRlXeTT1a83Mk-o', '2022-10-12 05:31:09.585722-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('fn8jg10zh2wtd5en1idh78l72bavpo2n', 'e30:1odsZM:nvLso5l5zO4xG6l-OXNWKmam180gfyfOl4RQ69Xw7vs', '2022-10-13 11:23:12.802829-01');
...
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('nxzztnwtqdy5myg8nhe41zobs8jcb5x1', '.eJxVjMEOwiAQBf-FsyFASy09evcbyMIuFjXQQJtojP-uJD3o9c28eTEL2zrbrVKxEdnEJDv8bg78jVIDeIV0ydzntJboeFP4Tis_Z6T7aXf_AjPU-ft2oCGAB21CJ0HgiP4owwhekSJJoRtIixG7XhgF0qgBUTshIOjQD9r4Fq1Ua8zJ0mOJ5ckm8f4Azwo_7g:1oq6nU:o776kxYzc6T1g7IWfL1FhAK4T-tOh62Swbl2aA-QI-0', '2022-11-16 05:00:20.401143-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('g1wn8ruk27pe9blfhcfgg0mwx2us8kse', '.eJxVjDsOwjAQBe_iGln-R5uSnjNYa3sh5mOjOJFAiLuToDRpZ96bD8P0yMVjjHUuk8-J9fLAPM7T4OdG458wyXYsYLxRWUW6YrlUHmuZxhz4OuGbbfxUE92P23YXGLANy1tYIQNAB9rq6FQUSoMhq1FJ6DqDQsuEzsBSdM6drThLALCgyIVgDazRRq3lWjy9nnl8s158fwDoRPo:1oqqDw:Dmu-2bVAudaUM_B_0DHdk94d0rpK1t700xPq-7CW2jQ', '2022-11-18 05:30:40.370375-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('0gt2yg679wjwwview091lzr3lby499cr', '.eJxVjMsKwjAQRf8lawl5l-nSvd8QJsnURiWRpoWK-O-20IVu7zn3vJnHZR790mjyObGeSXb63QLGO5UdpBuWa-WxlnnKge8KP2jjl5rocT7cv8CIbdzewgoZADrQVkenolAaDFmNSkLXGRRaJnQGtqJzbrBikABgQZELwRrYo41ay7V4Wp95erFefL4qpz2e:1orzNL:dejZhKEeK7m-p5Y1mS7Cee0GAmyXrPl1j2tKqJjjWuA', '2022-11-21 09:29:07.014225-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('6gxbfduiptdmxecanqj2yts9na89oa87', '.eJxVjMsKwjAQRf8lawl5l-nSvd8QJsnURiWRpoWK-O-20IVu7zn3vJnHZR790mjyObGeSXb63QLGO5UdpBuWa-WxlnnKge8KP2jjl5rocT7cv8CIbdzewgoZADrQVkenolAaDFmNSkLXGRRaJnQGtqJzbrBikABgQZELwRrYo41ay7V4Wp95erFefL4qpz2e:1osHsz:n1SgQEzx8rcbs1WAxhwbwNgw1DPAMj-DvU2554ABir4', '2022-11-22 05:15:01.717216-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('3fwse2isf2pocgc3yo9jfyhb6ucue66u', '.eJxVjsEOwiAQRP-FsyGF0kI9evcbyC67WNSAKW2iMf671vSg13lvJvMUHpZ59EvlyScSe6HE7jdDCBfOK6Az5FORoeR5SihXRW60ymMhvh42929ghDp-2q7tUPemhwCNYTUodhQjaNfZ1rBV0RqNuiUbWFMPnVVuQFIhohvY4vdV5VpTyZ7vtzQ9xL55vQGIqj9J:1ot3Gk:JIKOOI_0gVGsHCBr8sE2l7JcTt3scVAWCYKwZOyvwGg', '2022-11-24 07:50:42.273088-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('7rmwr566nyft0jkos4romg6jyjn9qwwa', '.eJxVjsEOwiAQRP-FsyGF0kI9evcbyC67WNSAKW2iMf671vSg13lvJvMUHpZ59EvlyScSe6HE7jdDCBfOK6Az5FORoeR5SihXRW60ymMhvh42929ghDp-2q7tUPemhwCNYTUodhQjaNfZ1rBV0RqNuiUbWFMPnVVuQFIhohvY4vdV5VpTyZ7vtzQ9xL55vQGIqj9J:1ouvxI:HIHe1Lc59Du977SfE8yFSSxbmINo5GRSHQ2lb3gV9Nk', '2022-11-29 12:26:24.1791-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('qzme7vb8htguogptuzzoj0tli8qs25r2', '.eJxVjsEOwiAQRP-FsyGF0kI9evcbyC67WNSAKW2iMf671vSg13lvJvMUHpZ59EvlyScSe6HE7jdDCBfOK6Az5FORoeR5SihXRW60ymMhvh42929ghDp-2q7tUPemhwCNYTUodhQjaNfZ1rBV0RqNuiUbWFMPnVVuQFIhohvY4vdV5VpTyZ7vtzQ9xL55vQGIqj9J:1oxPFc:OH4Tbw-zH0ThjpIz8XMPhP-8uE91G44eEXM5vyYdBRg', '2022-12-06 08:07:32.205241-01');
INSERT INTO django_session (session_key, session_data, expire_date) VALUES ('dlinnzy5yjdcf7w3rm02oz2algv13tys', '.eJxVjsEOwiAQRP-FsyGF0kI9evcbyC67WNSAKW2iMf671vSg13lvJvMUHpZ59EvlyScSe6HE7jdDCBfOK6Az5FORoeR5SihXRW60ymMhvh42929ghDp-2q7tUPemhwCNYTUodhQjaNfZ1rBV0RqNuiUbWFMPnVVuQFIhohvY4vdV5VpTyZ7vtzQ9xL55vQGIqj9J:1oy5ja:ko5ukrv_mPsNq1xGe8EkPTDapYD6oYG-Gk6WeWIL9ys', '2022-12-08 05:29:18.000992-01');
...
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (1, 'D1', 'I2', 27);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (2, 'D4', 'I16', 27);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (3, 'D5', 'I3', 27);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (4, 'D1', 'I2', 28);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (5, 'D4', 'I16', 28);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (6, 'D5', 'I3', 28);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (7, 'D1', 'I2', 29);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (8, 'D1', 'I2', 30);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (9, 'D2', 'I9', 30);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (10, 'D4', 'I16', 30);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (11, 'D5', 'I3', 30);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (12, 'D1', 'I2', 31);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (13, 'D1', 'I2', 32);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (14, 'D4', 'I16', 32);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (15, 'D5', 'I3', 32);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (16, 'D1', 'I2', 33);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (17, 'D4', 'I16', 33);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (18, NULL, 'I17', 33);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (19, NULL, 'I18', 33);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (20, 'D1', 'I2', 34);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (21, NULL, 'I17', 34);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (22, NULL, 'I18', 34);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (23, 'D1', 'I2', 35);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (24, NULL, 'I18', 35);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (25, 'D1', 'I2', 36);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (26, NULL, 'I17', 36);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (27, 'D1', 'I2', 37);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (28, 'D1', 'I2', 38);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (29, NULL, 'I17', 38);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (30, NULL, 'I19', 38);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (31, 'D1', 'I2', 39);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (32, NULL, 'I5', 39);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (33, 'D1', 'I2', 40);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (34, 'D6', 'I9', 40);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (35, 'D1', 'I2', 41);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (36, 'D1', 'I2', 42);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (37, 'D1', 'I2', 43);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (38, 'D1', 'I2', 44);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (39, 'D1', 'I2', 45);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (40, 'D1', 'I2', 46);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (41, 'D1', 'I2', 47);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (42, NULL, 'I5', 47);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (43, 'D1', 'I2', 48);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (44, 'D1', 'I2', 49);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (45, 'D1', 'I2', 50);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (46, 'D6', 'I9', 50);
INSERT INTO fieldschool (id, iddept, idinst, idvisit) VALUES (47, 'D1', 'I2', 51);
...
INSERT INTO institution (id, name) VALUES ('I1', 'Association Vahatra');
INSERT INTO institution (id, name) VALUES ('I2', 'University of Antananarivo');
INSERT INTO institution (id, name) VALUES ('I3', 'University of Fianarantsoa');
INSERT INTO institution (id, name) VALUES ('I4', 'University of Mahajanga');
INSERT INTO institution (id, name) VALUES ('I5', 'WWF Madagascar');
INSERT INTO institution (id, name) VALUES ('I6', 'Strategy Seminar');
INSERT INTO institution (id, name) VALUES ('I7', 'Madagascar National Parks');
INSERT INTO institution (id, name) VALUES ('I8', 'Indian Ocean Commission');
INSERT INTO institution (id, name) VALUES ('I9', 'Ecole Supérieure des Sciences Agronomiques');
INSERT INTO institution (id, name) VALUES ('I10', 'Office National pour l''Environnement (ONE)');
INSERT INTO institution (id, name) VALUES ('I11', 'Institut National des Sciences et Techniques Nucléaires');
INSERT INTO institution (id, name) VALUES ('I12', 'University of Hamburg');
INSERT INTO institution (id, name) VALUES ('I13', 'Kingfisher Group');
INSERT INTO institution (id, name) VALUES ('I14', 'Critical Ecosystem Partnership Fund (CEPF)');
INSERT INTO institution (id, name) VALUES ('I15', 'Invenergy');
INSERT INTO institution (id, name) VALUES ('I16', 'University of Toliara');
INSERT INTO institution (id, name) VALUES ('I17', 'University of Kwa-Zulu Natal, South Africa');
INSERT INTO institution (id, name) VALUES ('I18', 'University of Venda, South Africa ');
INSERT INTO institution (id, name) VALUES ('I19', 'CRVOI La Réunion');
INSERT INTO institution (id, name) VALUES ('I20', 'Madagascar Fauna and Flora Group ');
INSERT INTO institution (id, name) VALUES ('I21', 'Duke University');
INSERT INTO institution (id, name) VALUES ('I22', 'National Institute of Health (NIH)');
INSERT INTO institution (id, name) VALUES ('I23', 'National Science Foundation (NSF)');
INSERT INTO institution (id, name) VALUES ('I24', 'Korea International Cooperation Agency (KOICA)');
INSERT INTO institution (id, name) VALUES ('I25', 'United Nations Educational, Scientific and Cultural Organization (UNESCO)');
INSERT INTO institution (id, name) VALUES ('I26', 'Fonds Européen de Développement Régional (FEDER)');
INSERT INTO institution (id, name) VALUES ('I27', 'University of La Reunion');
INSERT INTO institution (id, name) VALUES ('I28', 'Processus Infectieux en Milieu Insulaire Tropical (PIMIT)');
INSERT INTO institution (id, name) VALUES ('I29', 'Global Challenges Research Fund (GCRF)');
INSERT INTO institution (id, name) VALUES ('I30', 'United Kingdom Research and Innovation (UKRI)');
INSERT INTO institution (id, name) VALUES ('I31', 'System of Protected Areas of Madagascar (SAPM)');
INSERT INTO institution (id, name) VALUES ('I33', 'REBIOMA');
INSERT INTO institution (id, name) VALUES ('I34', 'Tany Meva and UNESCO World Heritage program');
INSERT INTO institution (id, name) VALUES ('I35', 'CITES');
INSERT INTO institution (id, name) VALUES ('I36', 'Ministry of the Environment');
INSERT INTO institution (id, name) VALUES ('I37', 'The Peregrine Fund');
INSERT INTO institution (id, name) VALUES ('I40', 'Facebook lite');
INSERT INTO institution (id, name) VALUES ('I41', 'Facebook');
INSERT INTO institution (id, name) VALUES ('I32', 'Ambatovy-Sherritt International');
...
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (1, NULL, 'I1', 1, 'P1');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (2, 'D1', 'I2', 1, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (3, NULL, 'I1', 2, 'P3');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (4, NULL, 'I1', 2, 'P4');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (5, NULL, 'I1', 2, 'P5');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (6, 'D1', 'I2', 2, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (7, NULL, 'I1', 3, 'P3');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (8, NULL, 'I1', 3, 'P6');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (9, NULL, 'I1', 3, 'P7');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (10, 'D1', 'I2', 3, 'P9');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (11, 'D1', 'I3', 3, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (12, NULL, 'I1', 4, 'P10');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (13, NULL, 'I1', 4, 'P11');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (14, NULL, 'I1', 4, 'P12');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (15, 'D1', 'I2', 4, 'P13');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (16, 'D1', 'I2', 4, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (17, 'D1', 'I4', 4, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (18, NULL, 'I1', 5, 'P14');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (19, NULL, 'I1', 6, 'P15');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (20, NULL, 'I1', 7, 'P16');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (21, NULL, 'I1', 8, 'P17');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (22, NULL, 'I1', 8, 'P18');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (23, NULL, 'I1', 9, 'P17');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (24, NULL, 'I1', 9, 'P18');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (25, NULL, 'I1', 10, 'P17');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (26, NULL, 'I1', 10, 'P18');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (27, 'D1', 'I2', 11, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (28, NULL, 'I5', 12, 'P19');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (29, NULL, NULL, 13, 'P20');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (30, NULL, NULL, 13, 'P21');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (31, NULL, 'I6', 13, 'P28');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (32, NULL, 'I7', 14, 'P22');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (33, NULL, 'I8', 14, 'P23');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (34, 'D2', 'I9', 15, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (35, NULL, 'I2', 15, 'P24');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (36, NULL, 'I10', 16, 'P25');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (37, NULL, 'I11', 17, 'P25');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (38, 'D3', 'I12', 18, 'P2');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (39, NULL, 'I13', 19, 'P26');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (40, NULL, 'I14', 20, 'P27');
INSERT INTO memberpostinst (id, iddept, idinst, idmember, idpost) VALUES (41, NULL, 'I15', 21, 'P1');
...
INSERT INTO partner (id, description, link, logo, idinst, "isLink", description_en, description_fr) VALUES (4, 'biological evaluation and analysis of human pressures in a new UNESCO site.', 'https://tanymeva.org/', 'tanymeva.webp', 'I34', false, 'biological evaluation and analysis of human pressures in a new UNESCO site.', 'Evaluation éco-biologique et analyse des pressions, des menaces et des potentialités.');
INSERT INTO partner (id, description, link, logo, idinst, "isLink", description_en, description_fr) VALUES (5, 'scientific aid in evaluating biodiversity and training of field agents.', 'https://www.parcs-madagascar.com/', 'mnp.webp', 'I7', false, 'scientific aid in evaluating biodiversity and training of field agents.', ' Evaluation éco-biologique et analyse des pressions, des menaces et des potentialités – contribution à l’appui scientifique et à la formation des agents de PNM(Parcs National de Madagascar).');
...
INSERT INTO partner (id, description, link, logo, idinst, "isLink", description_en, description_fr) VALUES (3, 'Specialist in data exploitation and tools development for the management and conservation through modeling based on scientific information on biodiversity and ecological data.', 'https://www.rebioma.org/', 'rebioma.webp', 'I33', false, 'Specialist in data exploitation and tools development for the management and conservation through modeling based on scientific information on biodiversity and ecological data.', 'Spécialiste dans l''exploitation des données et dans le développement des outils au service de la gestion et de la conservation à travers la modélisation basée sur des informations scientifiques sur la biodiversité et les données écologiques.');
INSERT INTO partner (id, description, link, logo, idinst, "isLink", description_en, description_fr) VALUES (6, ' helping with the compilation of data concerning Malagasy taxa.', 'https://cites.org/eng', 'cites.webp', 'I35', false, ' helping with the compilation of data concerning Malagasy taxa.', 'Contribution à la compilation des données pour la CITES à travers l’appui en matière d’information au Secrétariat Permanent, à l’autorité scientifique et à l’organe de gestion.');
...
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P15', 'logistic coordinator', 'logistic coordinator', 'responsable logistique');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P1', 'president', 'president', 'président');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P2', 'professor', 'professor', 'professeur');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P3', 'scientific member', 'scientific member', 'scientifique');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P4', 'ornithologist', 'ornithologist', 'ornithologue');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P5', 'chef editor of Malagasy Nature', 'chef editor of Malagasy Nature', 'rédacteur en chef de Malagasy Nature');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P6', 'scientific coordinator', 'scientific coordinator', 'coordinateur scientifique');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P7', 'mammalogist', 'mammalogist', 'mammologue');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P9', 'head museum curator', 'head museum curator', 'conservateur en chef du musée');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P10', 'scientific advisor', 'scientific advisor', 'conseiller scientifique');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P11', 'vice president', 'vice president', 'vice président');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P12', 'co-editor of Malagasy Nature', 'co-editor of Malagasy Nature', 'co-rédacteur de Malagasy Nature');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P13', 'docteur honoris causa', 'docteur honoris causa', 'docteur honoris causa');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P14', 'financial & administration manager', 'financial & administration manager', 'responsable financier et administratif');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P16', 'domestic help', 'domestic help', 'femme de ménage');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P19', 'country director', 'country director', 'country director');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P20', 'général de corps d''armée', 'général de corps d''armée', 'général de corps d''armée');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P21', 'Center for Diplomatic and Strategic studies', 'Center for Diplomatic and Strategic studies', 'Centre d''études diplomatiques et stratégiques');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P22', 'former head of research and biodiversity', 'former head of research and biodiversity', 'responsable de la recherche et de la biodiversité');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P23', 'technical advisor', 'technical advisor', 'conseiller technique');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P24', 'ex-vice president', 'ex-vice president', 'ex-vice président');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P25', 'ex-general director', 'ex-general director', 'ex-directeur général');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P26', 'principal', 'principal', 'principal');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P27', 'executive director', 'executive director', 'directeur exécutif');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P28', 'director', 'director', 'directeur');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P17', 'guardian', 'guardian', 'gardien');
INSERT INTO post (id, name, name_en, name_fr) VALUES ('P18', 'gardener', 'gardener', 'jardinier');
...
INSERT INTO sequences_sequence (name, last) VALUES ('institution', 41);
INSERT INTO sequences_sequence (name, last) VALUES ('typesubactivity', 11);
INSERT INTO sequences_sequence (name, last) VALUES ('typeactivity', 26);
...
INSERT INTO typeactivity (id, type, type_en, type_fr) VALUES ('A1', 'Visit', 'Visit', 'Visite');
INSERT INTO typeactivity (id, type, type_en, type_fr) VALUES ('A2', 'Conference', 'Conference', 'Séminaire');
INSERT INTO typeactivity (id, type, type_en, type_fr) VALUES ('A4', 'Project', 'Project', 'Projet');
...
--
-- Data for Name: typememberimage; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA2', 'field schools', 'A1', 'field schools', 'field schools');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA1', 'science for the people', 'A1', 'science for the people', 'sciences pour le peuple');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA5', 'Vahatra''s cooperation', 'A2', 'Vahatra''s cooperation', 'collaboration de Vahatra');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA6', 'grant', 'A4', 'grant', 'subvention');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA7', 'scientific research', 'A4', 'scientific research', 'recherches scientifique');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA3', 'biological inventories', 'A1', 'biological inventories', 'inventaires biologiques');
INSERT INTO typesubactivity (id, type, idtypeactivity, type_en, type_fr) VALUES ('SA4', 'Vahatra''s event', 'A2', 'Vahatra''s event', 'événement de Vahatra');
...
SELECT pg_catalog.setval('activity_id_seq', 158, true);
...
SELECT pg_catalog.setval('activityimage_id_seq', 362, true);
...
SELECT pg_catalog.setval('activityinstitution_id_seq', 37, true);
...
SELECT pg_catalog.setval('activityperson_id_seq', 131, true);
...
SELECT pg_catalog.setval('django_migrations_id_seq', 93, true);
...
SELECT pg_catalog.setval('fieldschool_id_seq', 55, true);
...
SELECT pg_catalog.setval('image_id_seq', 155, true);
...
SELECT pg_catalog.setval('imagetype_id_seq', 10, true);
...
SELECT pg_catalog.setval('member_id_seq', 74, true);
...
SELECT pg_catalog.setval('memberpostinst_id_seq', 48, true);
...
SELECT pg_catalog.setval('messageofyear_id_seq', 1, true);
...
SELECT pg_catalog.setval('partner_id_seq', 14, true);
...
SELECT pg_catalog.setval('person_id_seq', 402, true);
...
SELECT pg_catalog.setval('publication_id_seq', 56, true);
...
SELECT pg_catalog.setval('publicationauthor_id_seq', 486, true);
...
SELECT pg_catalog.setval('publicationdetail_id_seq', 249, true);
...
SELECT pg_catalog.setval('typemember_id_seq', 11, true);


--
-- Name: typememberimage_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('typememberimage_id_seq', 12, true);
...
SELECT pg_catalog.setval('typepublication_id_seq', 9, true);
...
SELECT pg_catalog.setval('visit_id_seq', 75, true);
...
ALTER TABLE ONLY activityimage
...
ALTER TABLE ONLY activityinstitution
...
ALTER TABLE ONLY memberpostinst
...
ALTER TABLE ONLY messageofyear
...
ALTER TABLE ONLY publicationauthor
...
ALTER TABLE ONLY publicationdetail
    ADD CONSTRAINT publicationdetail_pkey PRIMARY KEY (id);


--
-- Name: report report_pdf_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY report
    ADD CONSTRAINT report_pdf_key UNIQUE (pdf);
...
ALTER TABLE ONLY sequences_sequence
...
--
-- Name: typememberimage typememberimage_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY typememberimage
    ADD CONSTRAINT typememberimage_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY typepublication
...
ALTER TABLE ONLY typesubactivity
...
CREATE INDEX activity_idtypeactivity_8153ff68 ON activity USING btree (idtypeactivity);
...
CREATE INDEX activity_idtypeactivity_8153ff68_like ON activity USING btree (idtypeactivity varchar_pattern_ops);
...
CREATE INDEX activity_idtypesubactivity_edc37fdf ON activity USING btree (idtypesubactivity);
...
CREATE INDEX activity_idtypesubactivity_edc37fdf_like ON activity USING btree (idtypesubactivity varchar_pattern_ops);
...
CREATE INDEX activity_slug_67fd3e44 ON activity USING btree (slug);
...
CREATE INDEX activity_slug_67fd3e44_like ON activity USING btree (slug varchar_pattern_ops);
...
CREATE INDEX activityimage_idactivity_76641d8a ON activityimage USING btree (idactivity);
...
CREATE INDEX activityinstitution_idactivity_ef745460 ON activityinstitution USING btree (idactivity);
...
CREATE INDEX activityinstitution_idinst_d34d2727 ON activityinstitution USING btree (idinst);
...
CREATE INDEX activityinstitution_idinst_d34d2727_like ON activityinstitution USING btree (idinst varchar_pattern_ops);
...
CREATE INDEX activityperson_idactivity_410644dd ON activityperson USING btree (idactivity);
...
CREATE INDEX activityperson_idperson_9c78d1db ON activityperson USING btree (idperson);
...
CREATE INDEX administrator_id_5fa297e8_like ON administrator USING btree (id varchar_pattern_ops);
...
CREATE INDEX administrator_username_2343b464_like ON administrator USING btree (username varchar_pattern_ops);
...
CREATE INDEX department_id_60525937_like ON department USING btree (id varchar_pattern_ops);
...
CREATE INDEX fieldschool_iddept_c231946d ON fieldschool USING btree (iddept);
...
CREATE INDEX fieldschool_iddept_c231946d_like ON fieldschool USING btree (iddept varchar_pattern_ops);
...
CREATE INDEX fieldschool_idinst_93831da0 ON fieldschool USING btree (idinst);
...
CREATE INDEX fieldschool_idinst_93831da0_like ON fieldschool USING btree (idinst varchar_pattern_ops);
...
CREATE INDEX fieldschool_idvisit_0fb3b620 ON fieldschool USING btree (idvisit);
...
CREATE INDEX image_idtype_9ed792c0 ON image USING btree (idtype);
...
CREATE INDEX institution_id_a19545b5_like ON institution USING btree (id varchar_pattern_ops);
...
CREATE INDEX member_idperson_4b45cdf7 ON member USING btree (idperson);
...
CREATE INDEX member_idtypemember_a1701687 ON member USING btree (idtypemember);
...
CREATE INDEX memberpostinst_iddept_130bb226 ON memberpostinst USING btree (iddept);
...
CREATE INDEX memberpostinst_iddept_130bb226_like ON memberpostinst USING btree (iddept varchar_pattern_ops);
...
CREATE INDEX memberpostinst_idinst_dc6e2b3f ON memberpostinst USING btree (idinst);
...
CREATE INDEX memberpostinst_idinst_dc6e2b3f_like ON memberpostinst USING btree (idinst varchar_pattern_ops);
...
CREATE INDEX memberpostinst_idmember_ec7fad30 ON memberpostinst USING btree (idmember);
...
CREATE INDEX memberpostinst_idpost_dfb553ea ON memberpostinst USING btree (idpost);
...
CREATE INDEX memberpostinst_idpost_dfb553ea_like ON memberpostinst USING btree (idpost varchar_pattern_ops);
...
CREATE INDEX messageofyear_idmember_2ab1dbf4 ON messageofyear USING btree (idmember);
...
CREATE INDEX partner_idinst_630ec2e1 ON partner USING btree (idinst);
...
CREATE INDEX partner_idinst_630ec2e1_like ON partner USING btree (idinst varchar_pattern_ops);
...
CREATE INDEX post_id_a84460e4_like ON post USING btree (id varchar_pattern_ops);
...
CREATE INDEX publication_idtype_701fb9f0 ON publication USING btree (idtype);
...
CREATE INDEX publicationauthor_idperson_ceef0fe3 ON publicationauthor USING btree (idperson);
...
CREATE INDEX publicationauthor_idpublication_fa82b830 ON publicationauthor USING btree (idpublication);
...
CREATE INDEX publicationdetail_idpublication_59d64763 ON publicationdetail USING btree (idpublication);


--
-- Name: report_pdf_5a8dd1a4_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX report_pdf_5a8dd1a4_like ON report USING btree (pdf varchar_pattern_ops);
...
CREATE INDEX sequences_sequence_name_667d3102_like ON sequences_sequence USING btree (name varchar_pattern_ops);
...
CREATE INDEX typeactivity_id_68c15a44_like ON typeactivity USING btree (id varchar_pattern_ops);
...
CREATE INDEX typeactivity_type_3925fcaa_like ON typeactivity USING btree (type varchar_pattern_ops);
...
CREATE INDEX typeactivity_type_en_9a42517c_like ON typeactivity USING btree (type_en varchar_pattern_ops);
...
CREATE INDEX typeactivity_type_fr_a83090a3_like ON typeactivity USING btree (type_fr varchar_pattern_ops);
...
CREATE INDEX typemember_type_e29de1a4_like ON typemember USING btree (type varchar_pattern_ops);
...
CREATE INDEX typemember_type_en_81bc8610_like ON typemember USING btree (type_en varchar_pattern_ops);
...
CREATE INDEX typemember_type_fr_9b394648_like ON typemember USING btree (type_fr varchar_pattern_ops);


--
-- Name: typememberimage_idtypemember_525b33c3; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX typememberimage_idtypemember_525b33c3 ON typememberimage USING btree (idtypemember);
...
CREATE INDEX typepublication_type_dd30792e_like ON typepublication USING btree (type varchar_pattern_ops);
...
CREATE INDEX typepublication_type_en_054b59d4_like ON typepublication USING btree (type_en varchar_pattern_ops);
...
CREATE INDEX typepublication_type_fr_527ac034_like ON typepublication USING btree (type_fr varchar_pattern_ops);
...
CREATE INDEX typesubactivity_id_fecf8b03_like ON typesubactivity USING btree (id varchar_pattern_ops);
...
CREATE INDEX typesubactivity_idtypeactivity_b4e8418d ON typesubactivity USING btree (idtypeactivity);
...
CREATE INDEX typesubactivity_idtypeactivity_b4e8418d_like ON typesubactivity USING btree (idtypeactivity varchar_pattern_ops);
...
CREATE INDEX typesubactivity_type_4487fe90_like ON typesubactivity USING btree (type varchar_pattern_ops);
...
CREATE INDEX typesubactivity_type_en_d0ba4318_like ON typesubactivity USING btree (type_en varchar_pattern_ops);
...
CREATE INDEX typesubactivity_type_fr_b15260dc_like ON typesubactivity USING btree (type_fr varchar_pattern_ops);
...
CREATE INDEX visit_idactivity_323a22de ON visit USING btree (idactivity);
...
CREATE INDEX visit_idlocation_9dc07eb8 ON visit USING btree (idlocation);
...
ALTER TABLE ONLY activity
    ADD CONSTRAINT activity_idtypeactivity_8153ff68_fk_typeactivity_id FOREIGN KEY (idtypeactivity) REFERENCES typeactivity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activity
    ADD CONSTRAINT activity_idtypesubactivity_edc37fdf_fk_typesubactivity_id FOREIGN KEY (idtypesubactivity) REFERENCES typesubactivity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activityimage
    ADD CONSTRAINT activityimage_idactivity_76641d8a_fk_activity_id FOREIGN KEY (idactivity) REFERENCES activity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activityinstitution
    ADD CONSTRAINT activityinstitution_idactivity_ef745460_fk_activity_id FOREIGN KEY (idactivity) REFERENCES activity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activityinstitution
    ADD CONSTRAINT activityinstitution_idinst_d34d2727_fk_institution_id FOREIGN KEY (idinst) REFERENCES institution(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activityperson
    ADD CONSTRAINT activityperson_idactivity_410644dd_fk_activity_id FOREIGN KEY (idactivity) REFERENCES activity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY activityperson
    ADD CONSTRAINT activityperson_idperson_9c78d1db_fk_person_id FOREIGN KEY (idperson) REFERENCES person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY fieldschool
    ADD CONSTRAINT fieldschool_iddept_c231946d_fk_department_id FOREIGN KEY (iddept) REFERENCES department(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY fieldschool
    ADD CONSTRAINT fieldschool_idinst_93831da0_fk_institution_id FOREIGN KEY (idinst) REFERENCES institution(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY fieldschool
    ADD CONSTRAINT fieldschool_idvisit_0fb3b620_fk_visit_id FOREIGN KEY (idvisit) REFERENCES visit(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY image
    ADD CONSTRAINT image_idtype_9ed792c0_fk_imagetype_id FOREIGN KEY (idtype) REFERENCES imagetype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY member
    ADD CONSTRAINT member_idperson_4b45cdf7_fk_person_id FOREIGN KEY (idperson) REFERENCES person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY member
    ADD CONSTRAINT member_idtypemember_a1701687_fk_typemember_id FOREIGN KEY (idtypemember) REFERENCES typemember(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY memberpostinst
    ADD CONSTRAINT memberpostinst_iddept_130bb226_fk_department_id FOREIGN KEY (iddept) REFERENCES department(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY memberpostinst
    ADD CONSTRAINT memberpostinst_idinst_dc6e2b3f_fk_institution_id FOREIGN KEY (idinst) REFERENCES institution(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY memberpostinst
    ADD CONSTRAINT memberpostinst_idmember_ec7fad30_fk_member_id FOREIGN KEY (idmember) REFERENCES member(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY memberpostinst
    ADD CONSTRAINT memberpostinst_idpost_dfb553ea_fk_post_id FOREIGN KEY (idpost) REFERENCES post(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY messageofyear
    ADD CONSTRAINT messageofyear_idmember_2ab1dbf4_fk_member_id FOREIGN KEY (idmember) REFERENCES member(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY partner
    ADD CONSTRAINT partner_idinst_630ec2e1_fk_institution_id FOREIGN KEY (idinst) REFERENCES institution(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY publication
    ADD CONSTRAINT publication_idtype_701fb9f0_fk_typepublication_id FOREIGN KEY (idtype) REFERENCES typepublication(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY publicationauthor
    ADD CONSTRAINT publicationauthor_idperson_ceef0fe3_fk_person_id FOREIGN KEY (idperson) REFERENCES person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY publicationauthor
    ADD CONSTRAINT publicationauthor_idpublication_fa82b830_fk_publication_id FOREIGN KEY (idpublication) REFERENCES publication(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY publicationdetail
    ADD CONSTRAINT publicationdetail_idpublication_59d64763_fk_publication_id FOREIGN KEY (idpublication) REFERENCES publication(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: typememberimage typememberimage_idtypemember_525b33c3_fk_typemember_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY typememberimage
    ADD CONSTRAINT typememberimage_idtypemember_525b33c3_fk_typemember_id FOREIGN KEY (idtypemember) REFERENCES typemember(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY typesubactivity
    ADD CONSTRAINT typesubactivity_idtypeactivity_b4e8418d_fk_typeactivity_id FOREIGN KEY (idtypeactivity) REFERENCES typeactivity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY visit
    ADD CONSTRAINT visit_idactivity_323a22de_fk_activity_id FOREIGN KEY (idactivity) REFERENCES activity(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY visit
    ADD CONSTRAINT visit_idlocation_9dc07eb8_fk_location_id FOREIGN KEY (idlocation) REFERENCES location(id) DEFERRABLE INITIALLY DEFERRED;
